...
CREATE TABLE `detail_satisfaction` (
  `id_detail_satisfaction` int(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `device_category` (
  `id_device_category` int(10) NOT NULL AUTO_INCREMENT,
  `device_category_name` varchar(50) NOT NULL,
  PRIMARY KEY (`id_device_category`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='หมวดหมู่อุปกรณ์';
...
CREATE TABLE `device_type` (
  `id_device_type` int(10) NOT NULL AUTO_INCREMENT,
  `device_type_name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_device_type`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='ประเภทอุปกรณ์';
...
CREATE TABLE `faculty` (
  `id_faculty` int(2) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `problem` (
  `id_problem` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `problem_type` (
  `id_problem_type` int(10) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='ตารางคำถามความพึงพอใจ';
...
CREATE TABLE `satisfaction` (
  `id_satisfaction` int(10) NOT NULL AUTO_INCREMENT,
  `id_repair` int(10) NOT NULL,
...
INSERT INTO token VALUES("1","s5706021610029","d060dbcaf54865a3","0000-00-00","1","1"),
("2","s5706021610029","401f4f6ae6b4b432","0000-00-00","","1");
...
CREATE TABLE `user_status` (
  `id_user_status` int(20) NOT NULL AUTO_INCREMENT,
